...
const STORAGE_KEY = 'ivacreativa_tiktok_crm_v7';
...
export function App() {
  ...
  const [state, setState] = useState<DJState>(() => {
    try {
      ...
      localStorage.removeItem('ivacreativa_tiktok_crm_v6');
    ...
    // Clean initial state with real clients: Terminal Marino (25 Agosto + 02 Septiembre) & Papá Plátano (Agosto pagado, prox 15 Septiembre)
